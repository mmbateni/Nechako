...
# Source: pre-computed *_basin_averaged_by_month.csv files.
# These indices were computed FROM basin-averaged climate inputs (correct).
# The previous approach of averaging time_XXX columns from per-pixel trend
# results (spi_XX_results.csv) was methodologically incorrect: spatially
# averaging standardised indices is not meaningful.
####################################################################################
cat("\n══════════════════════════════════════\n")
