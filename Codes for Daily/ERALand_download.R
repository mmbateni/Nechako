...
user_uid <- Sys.getenv("CDS_USER")
user_key <- Sys.getenv("CDS_KEY")
...
par_base_directory <- Sys.getenv("NECHAKO_WD")
base_download_directory <- paste0(par_base_directory,"ERA5-Land download-N and B")
