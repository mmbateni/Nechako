...
compute_both_indices <- function(start_year = 1950,
  ...
  var_file_spi <- file.path(output_dir_spi, "mspi_variance_explained_single.tif")
  writeRaster(var_rast_spi, var_file_spi, datatype = "FLT4S", 
  ...
  var_file_spei <- file.path(output_dir_spei, "mspei_variance_explained_single.tif")
  writeRaster(var_rast_spei, var_file_spei, datatype = "FLT4S", 
              overwrite = TRUE, NAflag = -9999)
