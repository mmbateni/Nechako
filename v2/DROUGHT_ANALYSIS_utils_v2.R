...
SPEI_THW_SEAS_DIR <- file.path(WD_PATH, "spei_results_seasonal_thw/")   # Thornthwaite PET outputs
...
#'   where index may be spi, spei (PM), spei_thw (Thornthwaite), or swei
#' File structure:
#'   Year | Jan | Feb | Mar | ??? | Dec
#'   1950 | -1.88 |  NA | ???
#'
#' @param index_type  "spi", "spei", "spei_thw", or "swei"
