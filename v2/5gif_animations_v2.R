...
# Framework: SPI + SPEI-PM + SPEI-Thw + SWEI. No detrended/counterfactual branch.
####################################################################################
...
# Observed-framework jobs only. SPEI-PM and SPEI-Thw are parallel observed
...
jobs <- c(
  ...
  if (dir.exists(SPEI_THW_SEAS_DIR))
    lapply(SPEI_THW_SCALES, function(sc)
      list("spei_thw", sc, SPEI_THW_SEAS_DIR, find_spei_thw_nc_safe))
  else list(),
